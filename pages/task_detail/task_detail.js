...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.getStorage({
      ...
      success: function (res) {
        ...
        console.log(that.data.item.starttime)
  ...
  //   var color = this.data.item.color;
  //   var path = 'pages/task_detail/task_detail?id=' + id + '&color=' + color;
  //   var url = '../share/share?url=' 
  //   util.share_model(session3rd, path, id, url, color)
  // },
  //邀请好友
  share: function () {
    var fid = this.data.item.fid;
